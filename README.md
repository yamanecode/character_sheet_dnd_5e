...
The tabletop version usually utilizes pen an paper to make the character sheets, the idea was to port this functionality to a digital version, allowing players to create, store and delete characters.

## Functionalities:
- The app can create a new character, with name, class, subclass, aligment, background, the stats and so on.
- The ability scores and modifiers have the built-in calculations (evey 2 ability scores = 1 modifier).
- Local storage.
